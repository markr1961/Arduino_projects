//
// from https://www.instructables.com/How-to-Make-Proper-Rainbow-and-Random-Colors-With-/
//

/*
* This table pre-calculates the sine function.
*/
...
uint8_t outputPins[] = {3, 5, 6 }// other PWM pins: 9, 10, 11
...
void setRGBpoint(byte LED, uint8_t red, uint8_t green, uint8_t blue)
{
  ...
  // remove the '255-' bits.
  analogWrite(outputPins[LED * 3 + 0], 255 - red);
