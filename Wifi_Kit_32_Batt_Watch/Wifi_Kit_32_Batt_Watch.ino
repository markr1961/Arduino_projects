...
/* (barely) modified from https://github.com/3KUdelta/heltec_wifi_kit_32_batt_monitor */
...
void setup()
{
    ...
    pinMode(LED_BUILTIN, OUTPUT); // or 'LED' see pins_arduino.h
